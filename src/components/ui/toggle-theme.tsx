 ...
 *
 * Integra el mecanismo del panel: cambia `data-theme` en el contenedor
 * `[data-panel]` y guarda la preferencia en la cookie `f3_tema`, que el
 * servidor lee para pintar el tema correcto en el siguiente render.
 */
